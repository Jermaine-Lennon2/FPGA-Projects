...
HD_PWD='C:/Users/jelen2/Desktop/Sequence_Detector/Sequence_Detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sequence_Detector_MOORE_Verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sequence_Detector_MOORE_Verilog.tcl
