...
HD_PWD='C:/Users/jelen2/Desktop/Sequence_Detector/Sequence_Detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sequence_Detector_MOORE_Verilog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sequence_Detector_MOORE_Verilog.tcl -notrace
